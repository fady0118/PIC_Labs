...
ul SW1_previous_state=PORTB&0x01;
ul SW2_previous_state=PORTB&0x02;
ul SW3_previous_state=PORTB&0x04;
...
void main(void) {
    Port_Init();
    while(1){
        if((PORTB&0x01)!=SW1_previous_state){
            PORTB^=0x08;
            SW1_previous_state=(PORTB&0x01);
        }
        if((PORTB&0x02)!=SW2_previous_state){
            PORTB^=0x08;
            SW2_previous_state=(PORTB&0x02);
        }
        if((PORTB&0x04)!=SW3_previous_state){
            PORTB^=0x08;
