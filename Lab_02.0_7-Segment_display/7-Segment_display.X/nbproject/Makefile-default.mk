...
FINAL_IMAGE=${DISTDIR}/7-Segment_display.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/7-Segment_display.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
